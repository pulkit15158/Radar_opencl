__kernel void convolution( __global int* out_channels, __global int* in_channels, __global int* kernel_size, __global float * img, __global float * weights, __constant float * bias, __global float * out_img, __global int* rows, __global int* cols)
{
